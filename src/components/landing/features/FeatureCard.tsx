...
const FeatureCard = ({
  ...
  return (
    <article
      className={`shadow-xl rounded-lg bg-linear-to-tl from-primary/35 via-accent/35 to-secondary/35 dark:from-primary/35 dark:via-accent/35 dark:to-secondary/35  hover:from-primary/60 hover:via-accent/60 hover:to-secondary/60 p-0.5 group ${
